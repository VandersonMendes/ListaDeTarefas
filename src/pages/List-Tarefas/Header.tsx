    ...
    <header className=" border-b-2 shadow-xl">
      <nav className='flex flex-wrap justify-around items-center container py-5 gap-3 xl:gap-4' >
        ...
        <nav className=''>
          ...
          {modal &&
            <div className="modalUser absolute z-50 right-50 max-[600px]:right-50 top-20 bg-black animeTop p-10 max-[768px]:p-5  ease-in flex flex-col items-center gap-4 rounded-b-xl  " style={{ backgroundColor: '#0013357c' }}>
